...
{
    // Base delay time.
    [Range(0.0f, 0.3f)] public float baseDelay = 0.1f;

    // Modulation depth.
    [Range(0.0f, 1.0f)] public float depth = 0.1f;

    // Modulation frequency.
    [Range(0.0f, 10.0f)] public float frequency = 0.2f;

    // Wet signal ratio.
    [Range(0.0f, 1.0f)] public float wetMix = 0.5f;
